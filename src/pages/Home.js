...
export default function HomePage() {
  ...
  const plans = [
    ...
    },
    {
      ...
      title: "Pro Plan",
      description: "Elevate your quiz experience",
      features: ["Unlimited Quiz Attempts", "Advanced Analytics", "Priority Support"],
      buttonText: "Upgrade Now",
      bgColor: "bg-gradient-to-br from-purple-500 to-purple-700",
      path: "/pro-plan",
    },
    {
      ...
      title: "Business Plan",
      description: "Empower your team's learning",
      features: ["Team Collaboration", "Custom Branding", "Dedicated Account Manager"],
      buttonText: "Explore Business",
      bgColor: "bg-gradient-to-br from-green-500 to-green-700",
      path: "/business-plan",
    },
    {
      ...
      title: "Enterprise",
      description: "Tailored solutions for large organizations",
      features: ["Full Customization", "Advanced Security", "24/7 Enterprise Support"],
      buttonText: "Contact Sales",
      bgColor: "bg-gradient-to-br from-red-500 to-red-700",
      path: "/enterprise",
    },
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <section>
          <h2 className="text-2xl font-bold text-center mb-8 text-gray-800">
            {user?.role === "admin" ? "User Management" : "Choose Your Plan"}
          </h2>
          {user?.role === "admin" ? (
            <UserManagement />
          ) : (
