  ...
  export const AnswerProvider = ({ children }) => {
    ...
    const getSessionAnswers = async (sessionId) => {
      ...
      try {
        ...
        const errorMessage = error.response?.data?.message || 'Failed to fetch session answers';
        dispatch({
    ...
    const getQuestionAnswers = async (sessionId, questionId) => {
      ...
      try {
        ...
        const errorMessage = error.response?.data?.message || 'Failed to fetch question answers';
        dispatch({
