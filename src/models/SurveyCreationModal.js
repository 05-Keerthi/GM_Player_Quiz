// SurveyCreationModal.js
import React from "react";
import { Sparkles, PenTool } from "lucide-react";

const SurveyCreationModal = ({
  isOpen,
  onClose,
  onCreateWithAI,
  onCreateBlank,
  ...
  const isArtPulse = surveyType === "ArtPulse";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            <div className="flex flex-col items-center text-center space-y-4">
              ...
              <h3 className="text-xl font-semibold">
                Create {isArtPulse ? "ArtPulse" : "Survey"} with AI
              </h3>
              <p className="text-gray-600">
                Let AI help you generate {isArtPulse ? "art-related" : "survey"}{" "}
                questions and content based on your topic
              </p>
            </div>
          </button>
          ...
          >
            <div className="flex flex-col items-center text-center space-y-4">
              ...
              <p className="text-gray-600">
                Start from scratch and create your{" "}
                {isArtPulse ? "ArtPulse" : "survey"} manually
              </p>
            </div>
          </button>
        </div>
